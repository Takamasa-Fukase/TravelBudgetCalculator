...
let defaultItineraryData: [DailyExpense] = [
    ...
    // Argentina
    DailyExpense(date: "9月14日（土）", cityName: "BuenosAires 1日目", currency: .ARA, expenseData: []),
    DailyExpense(date: "9月15日（日）", cityName: "BuenosAires 2日目", currency: .ARA, expenseData: []),
    DailyExpense(date: "9月16日（月）", cityName: "BuenosAires 3日目", currency: .ARA, expenseData: []),
    DailyExpense(date: "9月17日（火）", cityName: "Patagonia 1日目（El Chalten宿泊）", currency: .ARA, expenseData: []),
    DailyExpense(date: "9月18日（水）", cityName: "Patagonia 2日目（Fiz Royキャンプ）", currency: .ARA, expenseData: []),
    DailyExpense(date: "9月19日（木）", cityName: "Patagonia 3日目（El Calafate宿泊）", currency: .ARA, expenseData: []),
    ...
    // (Only Flight)
    DailyExpense(date: "10月9日（水）", cityName: "LA空港から東京に移動", currency: .USD, expenseData: [])
]
